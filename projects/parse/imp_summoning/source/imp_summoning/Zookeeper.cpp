...
namespace imp_summoning {
  ...
  Zookeeper::Zookeeper(underworld::Dungeon &underworld_root) :
    underworld_root(underworld_root),
    lookup(lexicon) {
    runic::Lexer_Lookup::initialize<runic::Keywords, runic::Double_Symbols, runic::Single_Symbols>(lexer_lookup,
                                                                                                   lexicon);
  }

  void Zookeeper::load_file(const std::string &path) {
